  ...
  ( "Try optional an repeatable parsers",
    Alcotest.
      [
        ...
        test_case
          "Should parse nothing with repeatable"
          `Quick
          should_parse_nothing_with_repeatable;
        test_case
          "Should parse no char with repeatable"
          `Quick
          should_parse_not_char_with_repeatable;
        test_case
          "Should parse million chars with repeatable"
          `Quick
          should_parse_million_chars_with_repeatable;
      ] )
